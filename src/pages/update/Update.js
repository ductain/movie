...
export default function Update() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            try {
                axios.put(`https://64914d492f2c7ee6c2c7f847.mockapi.io/api/v1/Movies/${id}`, values)
                navigate('/dashboard')
            } catch (error) {
                console.log(error)
            }
    ...
    return (
        <form onSubmit={formik.handleSubmit} style={{ padding: '100px 50px' }}>
            ...
            <TextField
                ...
                onChange={formik.handleChange}
            />
            {formik.errors.img && (<Typography variant="caption" color="red">
            ...
            <TextField
                ...
                onChange={formik.handleChange}
            />
            {formik.errors.detail && (<Typography variant="caption" color="red">{formik.errors.detail}</Typography>)}
            <br />
